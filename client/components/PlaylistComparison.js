...
//           <Link to={'/top'}>Go to Records</Link>
//         </div>
//       ) : (
...
//             {songs1.length > 0 ? (
//               <div>
//                 <h3>{songs1[0].Song.name} by {songs1[0].Song.artist}</h3>
...
//             {songs2.length > 0 ? (
//               <div>
//                 <h3>{songs2[0].Song.name} by {songs2[0].Song.artist}</h3>
      ...
      {showWinner ? (
        ...
        <div className="playlist-comparison-wrapper">
         {songs1.length > 0 ?  <div className="playlist-comparison-item">
            ...
            //   <div className="playlist-comparison-item-content">
            //   <span className="song-name"><u><b>{songs1[0].Song.name}</b></u></span>
            //   <span className="song-artist"> by {songs1[0].Song.artist}</span>
            //   <button className="playlist-comparison-button" onClick={handleVote2}>Vote</button>
            // </div>
            ) : <div></div>}
          </div> : <div></div>}
          {songs2.length > 0 ? <div className="playlist-comparison-item">
            ...
            {/* {songs2.length > 0 ? (
    <div className="playlist-comparison-item-content">
      <span className="song-name"><u><b>{songs2[0].Song.name}</b></u></span>
      <span className="song-artist"> by {songs2[0].Song.artist}</span>
      <button className="playlist-comparison-button" onClick={handleVote2}>Vote</button>
    </div>
  ): <div></div>} */}
          </div> :<div></div>}
